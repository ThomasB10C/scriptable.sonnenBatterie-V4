...
const apiURL3 = "http://" + IP + ":80/api/v2/battery" // CycleCount, CellTmperature
const apiURL4 = "http://" + IP + ":80/api/v2/io" // Reduction 1, 2
...
async function createWidget(items) {
  ...
  if (apiError == false && catchError == false) {
    ...
    state.cyclecount = data3.cyclecount
    state.minimumcelltemperature = data3.minimumcelltemperature
    state.maximumcelltemperature = data3.maximumcelltemperature
